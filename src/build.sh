...
#  sudo apt-get install python-dev gcc g++ make automake cmake scons bear build-essential libncurses5-dev libevent-dev libpango1.0-dev  golang cscope byacc libclang-12-dev exuberant-ctags
